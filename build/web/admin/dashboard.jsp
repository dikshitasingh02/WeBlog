	...
	$(document).on("click",".btn-primary",function(){
		...
		$.post(
			"add_category.jsp",{category:category},function(data){
                                data=data.trim();
				$(".table-borderless").prepend("<tr id='"+data+"'><td id='category-"+data+"'><h5>"+category+"</h5></td><td><i rel='"+data+"' class='fa fa-edit'></i></td><td><i rel='"+data+"' class='fa fa-trash'></i></td></tr>");
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="../admin/topic.jsp">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="../pages/image_upload.jsp">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Image Upload</span>
          </a>
        </li>
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a href="javascript:;" class="nav-link text-body font-weight-bold px-0">
                ...
                <span class="d-sm-inline d-none"><%=email%></span>
              </a>
            </li>
							...
							try{
								...
								while(rs.next()){
									...
									<tr id="<%=rs.getString("code")%>">
										<td id="category-<%=rs.getString("code")%>"><h5><%=rs.getString("category")%></h5></td><td><i rel="<%=rs.getString("code")%>" class="fa fa-edit"></i></td><td><i rel="<%=rs.getString("code")%>" class="fa fa-trash"></i></td>
									</tr>
									<%
								}
								cn.close();
